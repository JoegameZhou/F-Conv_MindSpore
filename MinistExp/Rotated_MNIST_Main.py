...
parser.add_argument('--dir',type = str, default = 'NormalNet' )
...
model = MinstSteerableCNN(10, tranNum)
...
if mode != 'test':
    ...
    for epoch in range(iniEpoch, maxEpoch):
        ...
        for data in train_loader:
            ...
            prediction, _ = mindspore.ops.ArgMaxWithValue(1)(y)
            total += label.shape[0]
            correct += (prediction == label).sum()
        ...
        if (epoch % testEvery == 0 and epoch>250):# or (epoch % 10 == 0 and epoch>150):
