...
class FieldType:
    ...
    def get_dense_change_of_basis(self) -> mindspore.Tensor(dtype=float32):
        """
        ...
        """
        return mindspore.Tensor(self.change_of_basis.todense(), dtype=float32)

    def get_dense_change_of_basis_inv(self) -> mindspore.Tensor(dtype=float32):
        """
        ...
        """
        return mindspore.Tensor(self.change_of_basis_inv.todense(), dtype=float32)

    def transform(self, input: mindspore.Tensor, element) -> mindspore.Tensor:
        r"""
        ...
        Args:
            input (mindspore.Tensor): input tensor
        ...
        return mindspore.tensor.from_numpy(transformed.astype(np.float32))
